...
# ==================================================Buttons=================
btn_clear_from = Button(right, text="clear from", font=('arial', 25, 'bold'), highlightbackground=color,
                        command=lambda: clear_from())
btn_clear_from.pack(side=TOP)

btn_clear_to = Button(right, text="clear to", font=('arial', 25, 'bold'), highlightbackground=color,
